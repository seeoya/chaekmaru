-- 시퀀스 1부터 1000까지
CREATE SEQUENCE ADMIN_MEMBER_SEQ START WITH 1 INCREMENT BY 1 MAXVALUE 100 CYCLE NOCACHE;
DROP SEQUENCE ADMIN_MEMBER_SEQ;

CREATE SEQUENCE BOOK_SEQ START WITH 1 INCREMENT BY 1 MAXVALUE 10000 CYCLE NOCACHE;
DROP SEQUENCE BOOK_SEQ;

CREATE SEQUENCE USER_PICK_SEQ START WITH 1 INCREMENT BY 1 MAXVALUE 10000 CYCLE NOCACHE;
DROP SEQUENCE USER_PICK_SEQ;

CREATE SEQUENCE USER_CART_SEQ START WITH 1 INCREMENT BY 1 MAXVALUE 10000 CYCLE NOCACHE;
DROP SEQUENCE USER_CART_SEQ;
...
CREATE TABLE TBL_ADMIN(
	...
	-- 시퀀스 사용방법
INSERT INTO TBL_ADMIN(A_NO, A_ID, A_NAME, A_PW) VALUES(ADMIN_MEMBER_SEQ.NEXTVAL, 'ADMIN123', 'ADMIN123', '123');
...
CREATE TABLE TBL_MEMBER_PICK(
	...
	MP_REG_DATE	TIMESTAMP
		...
		-- 시퀀스 사용방법 --
INSERT INTO TBL_MEMBER_PICK(UP_NO, M_ID, B_NO) VALUES(USER_PICK_SEQ.NEXTVAL, 1, 20);
...
CREATE TABLE TBL_MEMBER_CART(
	...
	C_MOD_DATE	TIMESTAMP
		...
		-- 시퀀스 사용방법 --
INSERT INTO TBL_MEMBER_CART(C_NO, M_ID, B_NO) VALUES(USER_CART_SEQ.NEXTVAL, 1, 20);
