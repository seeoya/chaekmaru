...
CREATE SEQUENCE CHART_SEQ START WITH 1 INCREMENT BY 1 MAXVALUE 10000 CYCLE NOCACHE;
...
DROP TABLE TBL_BOOK;
UPDATE TBL_BOOK SET B_COUNT = B_COUNT - 100 WHERE B_NO = 1;
...
INSERT INTO TBL_POINT_LIST VALUES('gildong', 1000000 , 'adsadasd', SYSTIMESTAMP);
...
INSERT INTO TBL_MEMBER_CART VALUES(120, 'gildong', 444, 1, SYSTIMESTAMP, SYSTIMESTAMP);
...
-------------------
CREATE TABLE TBL_SALES_CHART(
   SC_NO            NUMBER(4)       PRIMARY KEY,               
   SC_DAILY_SALES      NUMBER(20)      DEFAULT 0,
   SC_DAILY_SALES_DATE    TIMESTAMP ,  
   SC_SALES_CATE          NUMBER(20)   DEFAULT 0,
   SC_SALES_CATE_NAME     VARCHAR2(20)   NOT NULL,
   SC_SALES_CATE_DATE     TIMESTAMP,  
   SC_REG_DATE            TIMESTAMP,  
   SC_MOD_DATE            TIMESTAMP 
);
  
SELECT * FROM TBL_SALES_CHART;
DROP TABLE TBL_SALES_CHART;
